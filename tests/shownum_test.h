...
TEST(shownum_test, simpletest) {
    FILE *outputFile;
    TRAVIS ? outputFile = fopen("tests/output/output1.txt", "wb") : outputFile = fopen("/home/travis/build/zeropointsix/lab2/tests/output/output1.txt", "wb");
    if (outputFile == NULL) {
    ...
    char inFile[MAXLINE];
    TRAVIS ? strncpy(inFile, "tests/input/input1.txt", MAXLINE) : strncpy(inFile, "/home/travis/build/zeropointsix/lab2/tests/input/input1.txt", MAXLINE);
    load(txt, inFile);
    ...
    FILE *expectedData;
    TRAVIS ? expectedData = fopen("tests/expected/expected1.txt", "r") : expectedData = fopen("/home/travis/build/zeropointsix/lab2/tests/expected/expected1.txt", "r");
    FILE *outputData;
    TRAVIS ? outputData = fopen("tests/output/output1.txt", "r") : outputData = fopen("/home/travis/build/zeropointsix/lab2/tests/output/output1.txt", "r");
